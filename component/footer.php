<footer class="footer">
    <section class="fection">
        <div class="box">
           ...
           <!-- <a href="../panier.php"><i class="fas-fa-angle-right"></i>Panier</a> -->
            ...
            <a href=""><i class="fas-fa-angle-right"></i>Contactez-Nous</a> 
        </div>

        <div class="box">
            <h3>Contacts</h3>
            <p><i class="fas fa-phone"></i>     07 49 86 59 52</p>
            <p><i class="fas fa-envelope"></i>    b.ray@78yahoo.com</p>
            <p href=""><i class="fas fa-map-marker-alt"></i>    Villiers-Sur-Marne(94)</p>
        </div>
    ...
    <div class="bas">
        &copy; copyright @2023 B-Ray, Tous droits reservés!
    </div>
</footer>